...
public class SisgeaServletInitializer extends SpringBootServletInitializer {
    ...
    private static final String SISGEA_CFG = "SISGEA_CFG";
    ...
    protected SpringApplicationBuilder configure(SpringApplicationBuilder application) {
        String rutaArchivoConfigSISGEA = System.getenv(SISGEA_CFG);
        if (rutaArchivoConfigSISGEA != null) {
            log.info("La variable de entorno {} tiene el valor de {}", SISGEA_CFG, rutaArchivoConfigSISGEA);
            ...
            log.info("La variabla de entorno {} no existe", SISGEA_CFG);
